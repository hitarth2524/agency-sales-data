...
const SignUp = ({ onSignUp, children }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        err.response?.data?.errors?.[0]?.msg || err.response?.data?.msg || 'Sign up failed. Please try again.'
      );
      setLoading(false);
      setShake(true);
      setTimeout(() => setShake(false), 600);
    ...
    <div style={{
      ...
      <div style={{
        ...
        <svg width="100%" height="100%" viewBox="0 0 1000 1000" style={{ animation: 'float 20s ease-in-out infinite' }}>
          ...
          <circle cx="800" cy="300" r="100" fill="url(#bgGrad2)" />
          <circle cx="400" cy="700" r="120" fill="url(#bgGrad2)" />
        </svg>
      </div>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{
            ...
            Join us and start managing your sales
          </p>
        </div>
        ...
        >
            ...
            <div style={{
              ...
              <input
                ...
                style={{
                  ...
                  borderRadius: '12px',
                  border: focus.username ? '2px solid #43a047' : '2px solid rgba(102, 126, 234, 0.3)',
          ...
          <div style={{ marginBottom: '20px', position: 'relative' }}>
            <div style={{
              ...
              <svg width="20" height="20" viewBox="0 0 24 24" style={{
                ...
                left: '16px',
                zIndex: 2,
                fill: focus.email ? '#43a047' : 'rgba(255, 255, 255, 0.6)',
                transition: 'fill 0.3s ease',
              }}>
              ...
              <input
                ...
                onClick={e => handleRipple(e, 'email')}
                placeholder="Enter your email"
                style={{
                  width: '100%',
                  padding: '16px 16px 16px 48px',
                  borderRadius: '12px',
                  border: focus.email ? '2px solid #43a047' : '2px solid rgba(102, 126, 234, 0.3)',
                  background: 'rgba(255, 255, 255, 0.05)',
                  color: '#fff',
                  fontSize: '16px',
                  outline: 'none',
                  transition: 'all 0.3s ease',
                  boxShadow: focus.email ? '0 0 0 4px rgba(67, 160, 71, 0.1)' : 'none',
                }}
                onMouseOver={e => {
                  if (!focus.email) {
                    e.target.style.border = '2px solid rgba(102, 126, 234, 0.6)';
            ...
            <span ref={rippleRefs.email} className="ripple" style={{
              position: 'absolute',
              borderRadius: '50%',
              pointerEvents: 'none',
              opacity: 0,
            ...
            <div style={{
              ...
              <input
                ...
                style={{
                  ...
                  borderRadius: '12px',
                  border: focus.password ? '2px solid #43a047' : '2px solid rgba(102, 126, 234, 0.3)',
                  background: 'rgba(255, 255, 255, 0.05)',
                  color: '#fff',
                  fontSize: '16px',
                  outline: 'none',
          ...
          <div style={{ marginBottom: '32px', position: 'relative' }}>
            <div style={{
              ...
              <svg width="20" height="20" viewBox="0 0 24 24" style={{
                ...
                left: '16px',
                zIndex: 2,
                fill: focus.confirm ? '#43a047' : 'rgba(255, 255, 255, 0.6)',
                transition: 'fill 0.3s ease',
              }}>
                <path d="M12 17a2 2 0 0 0 2-2v-2a2 2 0 0 0-4 0v2a2 2 0 0 0 2 2zm6-6V9a6 6 0 0 0-12 0v2a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2zm-8-2a4 4 0 0 1 8 0v2H6V9z"/>
              </svg>
              ...
              <input
                ...
                onClick={e => handleRipple(e, 'confirm')}
                placeholder="Confirm your password"
                style={{
                  width: '100%',
                  padding: '16px 48px 16px 48px',
                  borderRadius: '12px',
                  border: focus.confirm ? '2px solid #43a047' : '2px solid rgba(102, 126, 234, 0.3)',
                  background: 'rgba(255, 255, 255, 0.05)',
                  color: '#fff',
                  fontSize: '16px',
                  outline: 'none',
                  transition: 'all 0.3s ease',
                  boxShadow: focus.confirm ? '0 0 0 4px rgba(67, 160, 71, 0.1)' : 'none',
                }}
                onMouseOver={e => {
                  if (!focus.confirm) {
                    e.target.style.border = '2px solid rgba(102, 126, 234, 0.6)';
            ...
            <span ref={rippleRefs.confirm} className="ripple" style={{
              position: 'absolute',
              borderRadius: '50%',
              pointerEvents: 'none',
              opacity: 0,
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '12px',
              border: 'none',
              background: loading ? 'rgba(102, 126, 234, 0.5)' : 'linear-gradient(135deg, #764ba2 0%, #667eea 100%)',
              color: '#fff',
              fontSize: '16px',
              fontWeight: 600,
