    ...
    <Box sx={{
      ...
      {showPreview && (
        <Box sx={{ mt: 4, mb: 4 }}>
          <Paper
            ...
            id="sales-preview"
          >
            <Typography variant="h5" sx={{ fontWeight: 'bold', color: 'black', mb: 2, textAlign: 'center', fontSize: { xs: 44, sm: 48, md: 52 } }}>{reportTitle ? reportTitle.toUpperCase() : ''}</Typography>
            <Typography id="doctor-print-title" variant="subtitle1" sx={{ mb: 2, fontWeight: 'bold', color: 'black', fontSize: { xs: 40, sm: 44, md: 48 } }}><b>DOCTOR NAME:</b> {doctor ? doctor.toUpperCase() : ''}</Typography>
            <TableContainer>
              <Table>
                <TableHead>
                  <TableRow>
            ...
            >
              <Box sx={{ flex: 1, minWidth: 220, maxWidth: 400, textAlign: 'left' }}>
                <Typography sx={{ fontWeight: 'bold', mb: 1, fontSize: { xs: 40, sm: 44, md: 48 } }}><b>Message / Notes:</b></Typography>
                <Typography sx={{ whiteSpace: 'pre-line', fontWeight: 'bold', fontSize: { xs: 40, sm: 44, md: 48 } }}>{message}</Typography>
              </Box>
              ...
              >
                <Box sx={{ textAlign: 'right' }}>
                  <Typography sx={{ fontWeight: 'bold', color: 'black', fontSize: { xs: 40, sm: 44, md: 48 }, mb: 0.5 }}>
                    <b>Sub Total: {subTotal.toFixed(2)}</b>
                  </Typography>
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', mb: 0.5 }}>
                    <Typography sx={{ fontWeight: 'bold', color: 'black', fontSize: { xs: 40, sm: 44, md: 48 }, mr: 1 }}>
                      <b>percentage (%):</b>
                    </Typography>
                    <TextField
                      value={disc}
                  ...
                  <Typography sx={{ fontWeight: 'bold', color: 'red', fontSize: { xs: 40, sm: 44, md: 48 }, mb: 0.5 }}>
                    <b>Percentage Amount:</b> {(subTotal * (parseFloat(disc) || 0) / 100).toFixed(2)}
                  </Typography>
                </Box>
              </Box>
      ...
      <style>{`
        @media print {
          ...
          .pdf-export #sales-preview th, .pdf-export #sales-preview .MuiTableCell-head { font-size: 64px !important; font-weight: bold !important; }
          .pdf-export #sales-preview td, .pdf-export #sales-preview .MuiTableCell-root { font-size: 56px !important; font-weight: bold !important; }
          .pdf-export #sales-preview .MuiTableCell-root input { display: block !important; }
          .pdf-export #sales-preview h5, .pdf-export #sales-preview .MuiTypography-h5 { font-size: 72px !important; font-weight: bold !important; }
          .pdf-export #sales-preview .doctor-name, .pdf-export #sales-preview .MuiTypography-subtitle1 { font-size: 68px !important; font-weight: bold !important; }
          .pdf-export #sales-preview .MuiTypography-root { font-size: 56px !important; font-weight: bold !important; }
          .pdf-export #sales-preview { padding: 60px !important; margin: 0 !important; }
        }
      `}</style>
