          ...
          >
            ...
            >
              <Box sx={{ flex: 1, minWidth: 220, maxWidth: 400, textAlign: 'left' }}>
                <Typography sx={{ fontWeight: 'bold', mb: 1, fontSize: { xs: 16, sm: 18, md: 20 } }}><b>Message / Notes:</b></Typography>
                <Typography sx={{ whiteSpace: 'pre-line', fontWeight: 'bold', fontSize: { xs: 16, sm: 18, md: 20 } }}>{message}</Typography>
              </Box>
              ...
              >
                <Box sx={{ textAlign: 'right' }}>
                  <Typography sx={{ fontWeight: 'bold', color: 'black', fontSize: { xs: 16, sm: 18, md: 20 }, mb: 0.5 }}>
                    <b>Sub Total: {subTotal.toFixed(2)}</b>
                  </Typography>
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', mb: 0.5 }}>
                    <Typography sx={{ fontWeight: 'bold', color: 'black', fontSize: { xs: 16, sm: 18, md: 20 }, mr: 1 }}>
                      <b>percentage (%):</b>
                    </Typography>
                    <TextField
                      value={disc}
